        ...
        <nav className="flex items-center justify-between w-full flex-wrap bg-gray-100 p-6">
            ...
            <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                ...
                <div>
                    ...
                    }} className="inline-block text-sm px-4 py-2 cursor-pointer leading-none rounded text-teal-500 border-white hover:border-transparent hover:text-teal-500 hover:font-bold mt-4 lg:mt-0">{userIsLogged ? 'Logout' : 'Login'}</a>
                </div>
            </div>
        </nav>
    )
