            ...
            <form onSubmit={handleFormSubmit} className="w-full max-w-lg">
                ...
                <div className="flex flex-wrap -mx-3 mb-6">
                    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input className="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" onChange={(event) => nameChange(event.target.value)} type="text" placeholder="Jane Doe" />
                    </div>
                ...
                <div className="md:flex md:items-end mt-4">
                    <button className="shadow bg-blue-700 ml-auto hover:bg-blue-600 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="submit">
                        Sign Up
                    </button>
                </div>
            </form>
